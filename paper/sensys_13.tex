...
% (e.g. network protocols and a radio driver),
...
% TODO
%An effective language for WSNs should provide control abstractions that can 
%better express program specifications, desirably ensuring that the high degree 
%of concurrency does not impose safety threats.
